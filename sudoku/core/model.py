...
class Model(object):
    ...
    def save(self, work_directory, name=''):
        """Save the model."""
        self.model.save(work_directory + '/model/model' + name + '.hdf')

    def load(self, work_directory, name=''):
        """Load the model."""
        self.model = kr.models.load_model(
            work_directory + '/model/model' + name + '.hdf')
